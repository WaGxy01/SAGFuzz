...
class Fuzzer:
    def __init__(self, contract_name, abi, deployment_bytecode, runtime_bytecode, test_instrumented_evm, blockchain_state, solver, args, seed, source_map=None,compiler_output=None, source_file=None):
        global logger
...
def print_logo():
    ...
    print("  / ___//   | / ____/ ____/_  __________")
    print("  \\__ \\/ /| |/ / __/ /_  / / / /_  /_  /")
    print(" ___/ / ___ / /_/ / __/ / /_/ / / /_/ /_")
    print("/____/_/  |_\\____/_/    \\__,_/ /___/___/")
    print("")
